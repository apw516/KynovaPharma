                ...
                <tbody>
                    @foreach ($data as $r)
                        ...
                        <tr>
                            ...
                            <td>
                                <button @if(auth()->user()->hak_akses != 1) disabled @endif class="btn btn-danger btn-sm retur" batch="{{ $r->kode_batch }}"
                                    stoksekarang="{{ $r->stok_sekarang }}"idsediaan="{{ $r->id }}">Retur</button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
