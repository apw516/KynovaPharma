                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card mt-2" id="datalist" hidden>
                            ...
                            <div class="card-body">
                                ...
                                <table id="tabelpoheader" class="table table-hover align-middle shadow-sm"
                                    style="width:100%">
                                    ...
                                    <tbody>
                                        @foreach ($hutang_data as $po)
                                            <tr class="{{ $po->status != '1' ? 'table-light opacity-75' : '' }}">
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="badge bg-secondary-subtle text-secondary small">{{ $po->pajak_persen }}%</span>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    @if ($po->status_bayar == '1')
                                                        <span
                                                            class="badge rounded-pill bg-info-subtle text-info border border-info-subtle px-2">Sudah
                                                            dibayar</span>
                                                    @else
                                                        <span
                                                            class="badge rounded-pill bg-danger-subtle text-danger border border-danger-subtle px-2">Belum
                                                            dibayar</span>
                                                    @endif
                                                </td>
                                                <td class="text-center">
                                                    <div class="btn-group shadow-sm">
                                                        <button class="btn btn-white btn-sm border btn-detail"
                                                            data-id="{{ $po->id }}" data-bs-toggle="modal"
                                                            data-bs-target="#modaldetail" title="Detail Faktur">
                                                            <i class="bi bi-eye text-info"></i>
                                                        </button>
                                                        @if ($po->status_bayar == '0')
                                                            <button @if (auth()->user()->hak_akses != 1) disabled @endif
                                                                class="btn btn-white btn-sm border btn-bayar"
                                                                data-id="{{ $po->id }}" title="Bayar">
