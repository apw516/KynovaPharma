            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Laporan Purchase Order</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header">Tabel Laporan Purchase Order</div>
                        <div class="card-body">
    ...
    <script type="text/javascript">
        ...
        function ambildatalog() {
            ...
            $.ajax({
                ...
                url: '<?= route('ambildatapurchaseorder') ?>',
                error: function(data) {
                    spinner_off()
                    Swal.fire({
                        icon: 'error',
